...
class SilverSubscription extends StatefulWidget {
  ...
  final String? restoreSubscriptionId;

  const SilverSubscription(this.data, {super.key, this.product, this.restoreSubscriptionId = "2"});

  @override
  State<SilverSubscription> createState() => _SilverSubscription();
}

class _SilverSubscription extends State<SilverSubscription> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Spacer(),
                Container(
                    margin: const EdgeInsets.fromLTRB(25, 20, 0, 15),
                    child: Text(
